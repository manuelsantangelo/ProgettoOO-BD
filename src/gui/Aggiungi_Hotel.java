...
public class Aggiungi_Hotel extends JFrame {
	...
	public Aggiungi_Hotel(Controller controller) {
		...
		textField_3.setBounds(746, 44, 173, 29);
		...
		textField_4.setBounds(24, 148, 173, 29);
		...
		list.setBounds(253, 148, 173, 29);
		contentPane.add(list);
		
		JTextArea txtrStelleMichelin = new JTextArea();
		txtrStelleMichelin.setText("Stelle");
		...
		txtrStelleMichelin.setBounds(1149, 11, 63, 29);
		...
		comboBox.setFont(new Font("Parametric Glitch", Font.PLAIN, 16));
		comboBox.setBackground(Color.BLACK);
		comboBox.setBounds(1150, 44, 43, 29);
		contentPane.add(comboBox);
		
		JList comboBox_1 = new JList();
		comboBox_1.setLayoutOrientation(JList.VERTICAL_WRAP);
		...
		comboBox_1.setBounds(499, 151, 206, 176);
		...
		textField_7.setFont(new Font("Parametric Glitch", Font.PLAIN, 16));
		textField_7.setColumns(10);
		textField_7.setBackground(Color.BLACK);
		textField_7.setBounds(1003, 44, 76, 29);
		...
		list_3.setModel(new AbstractListModel() {
			String[] values = new String[] {"Campo da Calcio", "Campo da Basket", "Campo da Tennis", "Campo da Golf", "Aria Condizionata", "WiFi", "Servizio in Camera", "Piscina", "Centro Benessere", "FrigoBar", "Mezza Pensione", "Pensione Completa", "Internet Point", "Sala Giochi", "Bar Interno", "Ristorante Interno", "Animal Friendly"};
			public int getSize() {
				return values.length;
			}
			public Object getElementAt(int index) {
		...
		list_3.setForeground(Color.GREEN);
		list_3.setFont(new Font("Parametric Glitch", Font.PLAIN, 16));
		list_3.setBackground(Color.BLACK);
		list_3.setBounds(746, 151, 206, 435);
